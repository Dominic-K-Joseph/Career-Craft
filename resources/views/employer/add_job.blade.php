                    ...
                    <form action="{{ route('employer.jobs.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="job_salary" id="job_salary" class="form-control"
                                placeholder="e.g., ₹30,000 - ₹50,000" value="{{ old('job_salary') }}">
                            @error('job_salary')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                            ...
                            <select name="job_location" id="job_location" class="form-select">
                                ...
                                @foreach ($locations as $location)
                                    <option value="{{ $location}}"
                                        {{ old('job_location') == $location ? 'selected' : '' }}>
                                        {{ $location }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input type="text" name="job_location" id="job_location" class="form-control"
                                placeholder="e.g., Kochi, Kerala" value="{{ old('job_location') }}">
                            @error('job_location')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div> --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="job_expirience" id="job_expirience" class="form-control"
                                placeholder="e.g., 2+ years" value="{{ old('job_expirience') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="job_description" id="job_description" class="form-control" rows="5"
                                placeholder="Describe the role...">{{ old('job_description') }}</textarea>
                        ...
                        {{-- Submit --}}
                        <div class="text-end">
                            <button type="submit" class="btn btn-success px-4">Submit Job</button>
                        </div>
                    </form>
                </div>
            </div>
